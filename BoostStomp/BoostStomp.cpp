...
//			break;
  ...
  {
	  hdrmap hm;
	  //the "subscription/" is a workaround for wacky HornetQ unsubscribe function...
	  hm["id"] = "subscription/" + topic; // + lexical_cast<string>(boost::this_thread::get_id()); //topic; lexical_cast<string>(m_subscription_id++); ....
